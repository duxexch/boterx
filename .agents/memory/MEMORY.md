...
- [Compensation system flow](comp-system.md) — player flow is in wallet.html /api/player/*; pending-account approvals; atomic p2p frozen transfer is the only money path
